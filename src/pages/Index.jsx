...
const Index = () => {
  ...
  const catBreeds = [
    ...
    { name: "Sphynx", description: "Hairless cats known for their wrinkled skin and outgoing personality." },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-purple-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            <h2 className="text-3xl font-semibold mb-4 text-purple-800">Cat Statistics</h2>
            <Card className="p-4">
